...
<main class="relative h-screen overflow-hidden bg-white dark:bg-pink-100">
    <header class="z-30 flex items-center w-full h-24 sm:h-32">
        <div class="container flex items-center justify-between px-6 mx-auto">
          <h2 className="font-bold text-gray-800 uppercase text-2xl">SoulScript</h2>
            ...
            <div class="flex items-center">
                {/* <nav class="items-center hidden text-lg text-gray-800 uppercase font-sen dark:text-white lg:flex">
                    <a href="#" class="flex px-6 py-2 text-indigo-500 border-b-2 border-indigo-500">
                        Home
                    </a>
                    <a href="#" class="flex px-6 py-2 hover:text-indigo-500">
                        Watch
                    </a>
                    <a href="#" class="flex px-6 py-2 hover:text-indigo-500">
                        Product
    ...
    <div class="relative z-20 flex items-center bg-white dark:bg-pink-100">
        <div class="container relative flex flex-col items-center justify-between px-6 py-8 mx-auto">
            <div class="flex flex-col">
                <h1 class="w-full text-4xl text-center text-gray-800 uppercase sm:text-5xl">
                    The Journal for everyday thoughts
                </h1>
                <h2 class="w-full max-w-2xl py-8 mx-auto text-xl font-light text-center text-gray-500">
                ...
                <div class="flex items-center justify-center mt-4">
                    <button type="button" onClick={() => router.push('/signup')} class="px-4 py-2 mr-4 text-white uppercase bg-red-900 border-2 border-transparent text-md hover:bg-gray-900">
                        Get started
                    </button>
                    <button type="button" onClick={() => router.push('/login')} class="px-4 py-2 text-gray-800 uppercase bg-transparent border-2 border-gray-800 hover:bg-gray-800 hover:text-white text-md">
                        Login
                    </button>
                </div>
            </div>
            <div class="flex justify-center items-center relative w-full mx-auto mt-6 md:mt-0">
                <Image 
                        src="/homepage.svg" 
                        width={400}
                        height={400}
