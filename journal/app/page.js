    ...
    <div className="relative z-20 flex items-center bg-white dark:bg-pink-100">
        <div className="container relative flex flex-col items-center justify-between px-6 py-8 mx-auto">
            <div className="flex flex-col">
                <h1 className="w-full text-4xl text-center text-gray-800 uppercase sm:text-5xl">
                ...
                <div className="flex items-center justify-center mt-4">
                    <button type="button" onClick={() => router.push('/signup')} className="px-4 py-2 mr-4 text-white uppercase bg-red-900 border-2 border-transparent text-md hover:bg-gray-900">
                        Get started
                    </button>
                    <button type="button" onClick={() => router.push('/login')} className="px-4 py-2 text-gray-800 uppercase bg-transparent border-2 border-gray-800 hover:bg-gray-800 hover:text-white text-md">
                        Login
                    </button>
                </div>
            </div>
